...
### Тест-кейс №12. Авторизация на сайте через Cookies

- **Предусловие**:
    1. Открыть браузер
    2. Перейти по ссылке: `https://sql-ex.ru/`
...
### Тест-кейс №13. Проверка работы JavaScriptExecutor
...
- **Шаги**:
    1. Ввести в поле `Логин` произвольное значение (см. `Тестовые данные`)
...
### Тест-кейс №14. Проверка работы drag and drop
...
### Тест-кейс №15. Проверка работы с несколькими вкладками
...
### Тест-кейс №16. Проверка работы Alert
...
### Тест-кейс №17. Проверка работы Basic Auth

- **Предусловие**:
    1. Открыть браузер

- **Шаги**:
    1. Авторизироваться при помощи Basic Auth (`httpwatch` и `httpwatch`)
...
- **Тестовые данные**:
    1. `Username` — `httpwatch`
    2. `Password` — `httpwatch`
